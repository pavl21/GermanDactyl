...
wget -q -O - https://github.com/pterodactyl/panel/releases/latest/download/panel.tar.gz | tar -xvz resources app routes database public
...
echo ""
echo "Patch-Modus betreten. Verändere jetzt keine Dateien mehr an GermanDactyl selbst, verändere nur noch Übersetzungen."
